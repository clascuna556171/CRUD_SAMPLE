...
@section('content')
  <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
      ...
      <span style="color: #718096;">ID: #{{ $department->department_id }}</span>
  </div>
    ...
    <form action="{{ route('departments.update', $department->department_id) }}" method="POST">
      ...
      <div class="form-group" style="margin-top: 15px;">
        ...
        <textarea name="description" 
                  ...
                  class="form-control" 
                  rows="4" 
                  placeholder="Describe the department's function...">{{ old('description', $department->description) }}</textarea>
      </div>

      <div style="margin-top: 30px; border-top: 1px solid #eee; padding-top: 20px;">
        <button type="submit" class="btn btn-primary" style="padding: 10px 20px;">Update Department</button>
